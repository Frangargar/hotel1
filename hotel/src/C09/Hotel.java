...
public class Hotel {
    ...
    public Hotel(){
        String [][] hotel = new String[NPLANT][NHAB];
        int p,h;
        for(p=0;p<NPLANT;p++)
            for (h=0;h<NHAB;h++)
                hotel[p][h]=vacio;
    ...
    public void BuscaHabitación(Hotel hab,Reserva reserva, MinInteger planta, MinInteger habit){
        int p,h;
    ...
    public boolean equals(Object o) {
        ...
        return NPLANT == hotel1.NPLANT && NHAB == hotel1.NHAB && Objects.equals(vacio, hotel1.vacio) && Arrays.equals(hotel, hotel1.hotel);
    }
